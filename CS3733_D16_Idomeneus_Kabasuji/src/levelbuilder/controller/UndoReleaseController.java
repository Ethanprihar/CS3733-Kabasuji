 ...
 *
 */
public class UndoReleaseController extends MouseAdapter {
	...
	String fn;
	JLabel[][] pieces;
	BuilderReleaseBoardView board;


	public UndoReleaseController(Builder builder, TopLevelApplicationBuilder app, JLabelIcon button, JLabel[] piece1, JLabel[] piece2, JLabel[] piece3, BuilderReleaseBoardView b) {
